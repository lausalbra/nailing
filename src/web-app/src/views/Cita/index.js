...
export function Cita() {
    ...
    return (
        <>
            ...
            <SlidingPane children={<div id={name+"Container"} class="propertyContainer"><PropertyPanel name={name} buttons="Esculpida,Uña natural,no se más,tipos de uña, aaaaaaaaaaaaaaaa" /></div> } title={state.id} isOpen={state.isPaneOpen} from="bottom" width="100%" onRequestClose={() => { setState({ isPaneOpen: false, id: "" });}}/>
        </>
    )
}

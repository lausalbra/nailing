...
export default function Paypal({ json, money, paymentType }) {
  ...
  const urlEditCentro = "https://nailing-sprint5.herokuapp.com/centros/edit"
  const urlLogout = "https://nailing-sprint5.herokuapp.com/logout"
  const headers = {
          ...
          switch (paymentType) {
            case "Reserve":
              $.ajax({
                ...
                data: json,
                url: "https://nailing-sprint5.herokuapp.com/cita/add",
              ...
              break;
            case "NewCentre":
              const urlCentre = "https://nailing-sprint5.herokuapp.com/centros/add/" + user.id.toString();

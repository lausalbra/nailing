...
export function UserDetails({ image, email, phone }) {
  ...
  async function handleClick() {
    ...
    const url2 = "https://nailing-sprint5.herokuapp.com/logout"
  ...
  var url = "https://nailing-sprint5.herokuapp.com/centros/show/"
  ...
  return (
    <Card style={{ backgroundColor: 'rgb(248, 225, 228)' }} sx={{ minWidth: 275 }}>
      ...
      <CardActions>
        <button onClick={() => locationPush('/creditosAtrasados')} className="border-2 border-purple-300 bg-pink-200 text-black w-96 py-3 rounded-md text-1xl font-medium hover:bg-purple-300 transition duration-300">Pagar créditos atrasados</button>
      </CardActions>
      :
      <></>

...
---------------------------------------------CENTROS---------------------------------------------
INSERT INTO centro (id, imagen, nombre, ubicacion) VALUES (1, null, 'Uñas Pepa', 'Málaga');
INSERT INTO centro (id, imagen, nombre, ubicacion) VALUES (2, null, 'Nails Factory', 'Sevilla');
INSERT INTO centro (id, imagen, nombre, ubicacion) VALUES (3, null, 'Mafalda Salón de Belleza', 'Cádiz');
